...
exports.retry = function (options, fn) {
    ...
    if ('number' === typeof options) {
        times = options;
    } else if ('object' === (typeof options === "undefined" ? "undefined" : _typeof(options))) {
        if (options.times) {
            times = parseInt(options.times, 10);
        }
        if (options.interval) {
            interval = parseInt(options.interval, 10);
        }
    } else {
        throw new Error('Unsupported argument type for \'times\': ' + (typeof options === "undefined" ? "undefined" : _typeof(options)));
    }
